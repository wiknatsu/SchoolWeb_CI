...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h2 class="text-2xl font-black text-slate-900 tracking-tight">Tulis Berita Baru</h2>
        <p class="text-xs text-slate-500 mt-1">Buat publikasi artikel atau pengumuman resmi terbaru sekolah.</p>
    </div>
        ...
        <div class="lg:col-span-8 space-y-6">
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 space-y-5">
                <div>
                    ...
                    <input type="text" name="title" id="title" value="<?= old('title') ?>" required class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition" placeholder="Tuliskan judul berita yang menarik...">
                </div>
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="2" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition" placeholder="Ringkasan singkat untuk tampilan kartu preview (opsional)..."><?= old('excerpt') ?></textarea>
                </div>
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 space-y-4">
                ...
                <div class="space-y-4 text-xs">
                    <div>
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" value="<?= old('meta_keywords') ?>" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="kata kunci, pisahkan dengan koma">
                    </div>
                    <div>
                        <label for="meta_description" class="block font-bold text-slate-700 mb-1">Meta Description</label>
                        <textarea name="meta_description" id="meta_description" rows="2" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Deskripsi meta untuk mesin pencari Google..."><?= old('meta_description') ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 space-y-5">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="published_at" id="published_at" value="<?= old('published_at', date('Y-m-d\TH:i')) ?>" class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs">
                </div>

                <div class="pt-2 flex items-center space-x-3 bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <input type="checkbox" name="is_highlighted" id="is_highlighted" value="1" <?= old('is_highlighted') ? 'checked' : '' ?> class="w-4 h-4 text-blue-600 rounded focus:ring-blue-500 border-slate-300">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 space-y-4">
                ...
                <div class="aspect-[16/10] rounded-2xl overflow-hidden bg-slate-100 border-2 border-dashed border-slate-200 flex items-center justify-center relative">
                    <img id="imagePreview" src="https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=600&q=80" alt="Preview" class="w-full h-full object-cover">
                </div>
                ...
                <p class="text-[11px] text-slate-400">Format JPG, PNG, WebP (Maks. 3 MB)</p>
            </div>
            ...
            <div class="pt-2">
                <button type="submit" class="w-full py-3.5 px-6 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm shadow-lg shadow-blue-600/25 transition">
                    <i class="fas fa-save mr-2"></i> Simpan & Publikasikan Berita
                </button>
            </div>
        </div>
    </div>
